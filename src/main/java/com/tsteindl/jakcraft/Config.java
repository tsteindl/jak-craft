...
//
// The three lists below hold the German "voice lines" the boss shows in chat.
...
public class Config {
  ...
  // Played whenever the king starts an attack.
  ...
  static {
    ...
    ATTACK_LINES = builder
        .comment("Zeilen bei jedem Angriff (eine wird zufällig gewählt).")
